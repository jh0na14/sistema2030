...
$(document).on('click','.darBaja',function(e){
  ...
  $.ajaxSetup({
    ...
    $.ajax({
            type: "PUT",
            url: '/socios/darBaja/'+value,
            data: {'id':value},
            dataType: 'json',
            success: function (data) {
                console.log(data);
                $("#msjshow").show();
                $("#msjshow").html(" <strong>Well done!</strong> You successfully delete "+value);
...
$(document).on('click','.darAlta',function(e){
   var value = $(this).val();
  //Otra forma de realizar el get ajax 
  //token siempre para ingresar y modificar
  $.ajaxSetup({
    ...
    $.ajax({
            ...
            error: function (data) {
                console.log('Error al dar Alta:', data);
            }
       }); 
});
////////////////Esto para busqueda
